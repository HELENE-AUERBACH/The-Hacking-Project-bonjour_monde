...
Dotenv.load('.env') # Ceci appelle le fichier .env (situé dans le même dossier que celui d'où est exécuté app.rb)
                    # et, grâce à la gem Dotenv, ceci importe toutes les données enregistrées dans un hash ENV.

def login_twitter
  # Ces quelques lignes appellent les clés d'API du fichier .env
